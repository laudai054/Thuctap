			...
			<div class="col-sm-2 sidenav">
				<p>
					<a class="btn btn-primary" style="width: 200px"
						href="AdminQLDonHang">Quản lý hóa đơn</a>
				</p>
				<p>
					<a class="btn btn-primary" style="width: 200px" href="AdminQLCTHD">Quản
						lý chi tiết hóa đơn</a>
				</p>
						...
						<c:forEach items="${addshd}" var="s">
							<tr>
								...
								<th><a class="btn btn-warning"
									href="AdminXoaDonHang?mhd=${s.getMaHoaDon()}"
									style="width: 50px">Xóa</a></th>
							</tr>
						</c:forEach>
					</tbody>
				</table>
		...
		<div class="modal-dialog modal-sm">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">Bạn đang thêm hóa đơn</h4>
				</div>
				<div class="modal-body">
					<form method="post" action="AdminThemHD">
						<label> Mã loại giày: </label> <input name="maloai" type="text"
							class="form-control"> <label> Tên loại giày: </label> <input
							name="tenloai" type="text" class="form-control"> <label>
							Tên loại giày: </label> <input name="tenloai" type="text"
							class="form-control"> <label> Tên loại giày: </label> <input
							name="tenloai" type="text" class="form-control"> <br>
