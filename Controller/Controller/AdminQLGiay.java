...
/**
 * Servlet implementation class AdminQLGiay
 */
@WebServlet("/AdminQLGiay")
public class AdminQLGiay extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
		    ...
		    RequestDispatcher rd= request.getRequestDispatcher("AdminQLGiay.jsp");
